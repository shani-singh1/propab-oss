...
# Domain-agnostic text-relevance utilities moved to core (propab.text_relevance)
# so propab-core no longer imports UP into services (ADR A2). Re-exported here for
# this module's callers and any external importers.
from propab.text_relevance import (  # noqa: E402
